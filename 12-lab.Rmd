...
**Note**: Make sure that you include the following libraries and formatting code at the beginning of your `index.Rmd` file
...
Now, please create 2 figures of your own, either using the code from last week's lab, or creating new figures based on the data created by the `process_COVID_data.R` code.
